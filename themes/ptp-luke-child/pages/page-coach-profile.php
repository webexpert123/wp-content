                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="d-flex justify-content-between align-items-center profile-header">
                            <h2>Learn Vollyball with Christian</h2>
                                ...
                                <div class="about-profiler">
                                    <div class="profiler-detail">
                                        <div class="d-flex align-items-start justify-content-between">
                                            <div class="pd-left">
                                                <h4>Meet your coach, Christian</h4>
                                                <ul class="mt-3 mb-3">
                                                    <li>
                                                        <a href="#">
                                        ...
                                        <div class="profile-meta">
                                            ...
                                            <div class="meta-about">
                                                <p>What are the rules of pickleball? Need a comfortable space to learn it all in 1 lesson with absolutely no judgment? I am here to teach beginners who are just getting started in Pickleball! If you want to
                                                    learn the basic rules of the game so you can start playing, I'm your guy. Will even have a partner or two so we can run a simulated game & by the end of our 1st session, I guarantee you will know all
                                                    the rules of pickleball & how to play! **If you're an intermediate or advanced player, get ready to work, you will specifically drill with me to get you from a 3.0 to a 4.0+ or 4.0 to a 5.0+!**</p>
                                                <a href="javascript:void(0);">Read More <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-right"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg></a>
                                            </div>
                                        </div>
                                    </div>
