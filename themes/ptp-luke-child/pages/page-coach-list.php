...
<div id="frontend-main" class="listing-page">
            <div class="hero-inner-wrapper">
                <section id="hero-inner" class="inner section light-background">
                        <div class="bloc-inner-video">
                            <div class="video-overlay"></div>
                            <div class="banner-image">
                                <img class="img-fluid" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/coach_listing_banner.jpg" alt="coach-listing-banner" >
                            </div>
                            <div class="container">
            ...
            <div class="container">
                <div class="row">
                            ...
                            <div class="filter-left">
                                <div class="row align-items-end">
                                    ...
                                    <div class="filter-item col-md-9">
                                        ...
                                        <div class="multiple-filter d-flex align-items-end">
                                                <!-- <div class="dropdown">
                                                    ...
                                                    <a class="dropdown-item" href="#">Best Price</a>
                                                    </div>
                                                </div> -->
                                                <div class="dropdown">
                                                    <select class="form-control" name="sports">
                                                        ...
                                                        foreach($results as $row){ ?>
                                                            <option value="<?php echo $row->sportID; ?>" <?php if($row->sportID==$_REQUEST['sport']){echo 'selected'; }?> ><?php echo $row->sport_name;; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            <!-- <div class="dropdown schedule-filter">
                                                <button class="btn btn-secondary dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false">
                                                Any Time
                                                </button>
                                            ...
                                            <!-- <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                <a class="dropdown-item" href="#">Kid (12 or under)</a>
                                                <a class="dropdown-item" href="#">Teenager (13 to 17 years old)</a>
                                                <a class="dropdown-item" href="#">Adult (18 to 64 years old)</a>
                                                <a class="dropdown-item" href="#">Senior (65 or older)</a>
                                                </div>
                                            </div> -->
                    ...
                    <div class="col-md-12 col-lg-12">
                        <div class="listing-main">
                                ...
                                <div class="row">
                                    ...
                                    if ( ! empty( $coaches ) ) {
                                        foreach ( $coaches as $coach ) {
                                          ...
                                          $imageID = get_user_meta($cochID, "_profile_pic_id", true);

                                          $coch_name = get_user_meta($cochID, "fullname", true);

                                          $description = get_user_meta($cochID, "_about_myself", true);
                                          $max_length = 150; 
                                          ...
                                          $sport_name = $wpdb->get_var($wpdb->prepare("SELECT sport_name FROM `{$wpdb->prefix}sports` WHERE sportID= '$sportID'"));

                                          $address = get_user_meta($cochID, "_full_address", true);

                                          $link = site_url("/coach-profile/".$coach->user_nicename);

                                          $coach_reviews = $wpdb->get_results($wpdb->prepare("SELECT * FROM `{$wpdb->prefix}coach_reviews` WHERE coach_id='$cochID' "));

                                          $total_reviews = count($coach_reviews);

                                          $average_rating = $wpdb->get_var($wpdb->prepare("SELECT AVG(rating) FROM `{$wpdb->prefix}coach_reviews` WHERE coach_id='$cochID'"));

                                          $facebook = get_user_meta($cochID, '_facebook', true);

                                          $instagram = get_user_meta($cochID, '_instagram', true);

                                          $tiktok = get_user_meta($cochID, '_tiktok', true);
                                                ...
                                                <div class="card">
                                                    <div class="card-header p-0">
                                                        ...
                                                        <div class="card-over-content">
                                                            <div class="variefied-icon">
                                                                <!-- <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/verified.svg" alt="verified_icons" /> -->
                                                            </div>
                                                            <span class="ratings-badge"><i class="fa-solid fa-star"></i>&nbsp;<strong><?php echo $average_rating; ?></strong>&nbsp;(<?php echo $total_reviews; ?>)</span>
                                                        </div>
                                                        <div class="card-over-bottom">
                                                            <div class="card-btm-content">
                                                                <ul>
                                                                    <?php
                                                                    if(!empty($facebook)){
                            ...
                            <!-- <div class="custom-button d-flex align-items-center gap-2 justify-content-center mt-3 mb-3">
                                <button type="button" class="btn btn-round btn-fill">Load More&nbsp;<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-right"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg></button>
                            </div> -->
                        </div>
                    </div>
                    <div class="col-md-12 col-lg-12">
                        <div class="summer-camp mt-4 mb-5">
                            <div class="card">
                                <div class="card-body">
                                                ...
                                                <div class="camp-item">
                                                    <div class="loc-top-content">
                                                        ...
                                                        <div class="custom-button">
                                                            <button type="button" class="btn-outliner" onclick="window.location.href='<?php echo site_url('summercamp/'.$post_slug.'/'); ?>'">Join Now!</button>
                                                        </div>
                                                    </div>
                                                </div>
                                        <?php }
             ...
             <!--Reward Section Start-->
              ...
              <!--Reward Section End-->
              <section id="story-video" class="bg-white">
                <div class="container">
                  <div class="row">
                      <div class="col-md-12 col-lg-12">
                          <div class="summer-camp section-spacing pt-4 pb-4">
                              <div class="card">
                                  <div class="card-body pb-5 pt-4">
                                      <div class="section-title mb-5 text-center">
                                          <h2>Listen to the Story From Our Top Trainer!</h2>
                                          <p>Discover the journey and insights from our top trainer, who has helped<br> countless athletes achieve their best.</p>
                                      </div>
